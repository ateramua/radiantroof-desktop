...
// Optional: deal metrics calculation (if used elsewhere)
export function calculateDealMetrics(dealData, setDealData) {
  const { arv, repairCosts, purchasePrice, monthlyRent, interestRate, downPaymentPercent, closingCosts } = dealData;
...
export function calculateDealScore({ roi, coc, dscr, capRate, monthlyCashFlow, profit, mao, purchasePrice }) {
  let score = 0;
