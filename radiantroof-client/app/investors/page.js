...
export default function DashboardLayout({ children }) {
  ...
  // Don't render anything if not authenticated or if investor (will redirect)
  if (!user || user.role === 'invest') {
    return null;
  }

  // User is authenticated and is either admin or regular user
  return (
            ...
            <div className="flex-1 truncate">
              ...
              <div className="flex items-center space-x-1">
                <p className="text-xs text-gray-500">
                  {user?.role === 'admin' ? 'Administrator' : 'Flipper'}
                </p>
                {user?.role === 'admin' && (
            ...
            {user?.role === 'admin' && (
              <>
                <div className="pt-4 mt-4 border-t border-purple-200">
                  <p className="px-2 text-xs font-semibold text-purple-400 uppercase tracking-wider">
                    Admin Access
                  </p>
                </div>
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Welcome back{user?.name ? `, ${user.name}` : ''}! Here's what's happening with your deals today.
              </p>
            </div>
